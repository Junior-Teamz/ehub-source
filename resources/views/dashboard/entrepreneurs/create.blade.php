...
<div class="justify-center max-xl:w-full">
    <div class="flex-col bg-white rounded-xl p-8 drop-shadow-lg">
        <h1 class="text-xl text-gray-800 mb-8">Tambah Wirausaha Baru</h1>
        <form class="flex flex-col w-full" method="POST" enctype="multipart/form-data" action="{{ route('dashboard.entrepreneurs.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-8 mb-8">
                <div class="flex flex-col">
                    ...
                    <input type="text" name="fullname" placeholder="Nama Wirausaha" value="{{ old('fullname') }}" required
                ...
                <div class="flex flex-col">
                    ...
                    <input type="email" name="email" placeholder="Email Wirausaha" value="{{ old('email') }}" autocomplete="off" required
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('email')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" name="phone_number" placeholder="Nomor Telepon Wirausaha" required
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary" value="{{ old('phone_number') }}">
                    @error('phone_number')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="born_place" placeholder="Tempat Lahir" value="{{ old('born_place') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('born_place')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="date" name="born_date" placeholder="Tanggal Lahir" value="{{ old('born_date') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('born_date')
                ...
                <div class="flex flex-col">
                    <label class="text-gray-600 font-semibold mb-1">Password <span class="text-red-500">*</span></label>
                    <input type="password" name="password" placeholder="Password" value="{{ old('password') }}" autocomplete="new-password" required
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('password')
                ...
                <div class="flex flex-col">
                    <label class="text-gray-600 font-semibold mb-1">Konfirmasi Password <span class="text-red-500">*</span></label>
                    <input type="password" name="password_confirmation" placeholder="Ketik Ulang Password" value="{{ old('password_confirmation') }}" required
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
            ...
            <div class="grid grid-cols-2 gap-8 mb-8">
                <div class="flex flex-col">
                    ...
                    <input type="text" name="business_name" placeholder="Nama Usaha / Ide Usaha yang akan dikembangkan" value="{{ old('business_name') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('business_name')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="nib_number" placeholder="Nomor Induk Berusaha" value="{{ old('nib_number') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('nib_number')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="nib_created_at" placeholder="Tahun Pembuatan NIB" value="{{ old('nib_created_at') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                ...
                <div class="flex flex-col col-span-full">
                    ...
                    <textarea type="text" name="business_address" placeholder="Alamat Lengkap Usaha" rows="3"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">{{ old('business_address') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-8 mb-8">
                <div class="flex flex-col">
                    ...
                    <input type="text" name="ig_account" placeholder="Nama Profile Akun Instagram Usaha" value="{{ old('ig_account') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('ig_account')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="fb_account" placeholder="Nama Profile / Halaman Facebook Usaha" value="{{ old('fb_account') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('fb_account')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="tiktok_account" placeholder="Nama Profile Tiktok Usaha" value="{{ old('tiktok_account') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="business_site" placeholder="Alamat URL Situs Usaha" value="{{ old('business_site') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('business_site')
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="community" placeholder="Nama Komunitas Usaha" value="{{ old('community') }}"
                        class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary">
                    @error('community')
                ...
                <div class="flex flex-col col-span-full">
                    ...
                    <div class="flex flex-col gap-4 ml-2">
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="shopee" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="shopee" />
                            <label for="shopee" class="ml-4 text-[#374151] cursor-pointer">Shopee</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="tokopedia" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="tokopedia" />
                            <label for="tokopedia" class="ml-4 text-[#374151] cursor-pointer">Tokopedia</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="blibli" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="blibli" />
                            <label for="blibli" class="ml-4 text-[#374151] cursor-pointer">Blibli</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="lazada" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="lazada" />
                            <label for="lazada" class="ml-4 text-[#374151] cursor-pointer">Lazada</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="bukalapak" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="bukalapak" />
                            <label for="bukalapak" class="ml-4 text-[#374151] cursor-pointer">Bukalapak</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="gojek" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="gojek" />
                            <label for="gojek" class="ml-4 text-[#374151] cursor-pointer">Gojek</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="grab" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="grab" />
                            <label for="grab" class="ml-4 text-[#374151] cursor-pointer">Grab</label>
                        </div>
                        <div class="flex flex-row items-center">
                            <input type="checkbox" id="lainnya" class="p-2 text-primary border border-gray-400 rounded focus:ring-primary cursor-pointer" name="business_platform[]" value="lainnya" />
