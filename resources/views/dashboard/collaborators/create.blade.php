...
<div class="justify-center max-xl:w-full">
    <div class="flex-col bg-white rounded-xl p-8 drop-shadow-lg">
        <h1 class="text-xl text-gray-800 mb-8">Tambah Kolaborator Baru</h1>
        <form class="flex flex-col w-full" method="POST" enctype="multipart/form-data" action="{{ route('dashboard.collaborators.store') }}">
            @csrf
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <input type="text" name="name" placeholder="Nama Kolaborator"
                    class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <input type="text" name="director_name" placeholder="Nama Pimpinan"
                    class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary" value="{{ old('director_name') }}">
                @error('director_name')
            ...
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <input type="email" name="email" placeholder="Email Kolaborator"
                    class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary" value="{{ old('email') }}">
                @error('email')
            ...
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <input type="number" name="phone_number" placeholder="Nomor Telepon Kolaborator"
            ...
            <div class="flex flex-col w-11/12 ml-10 mb-8">
                <label class="text-gray-600 font-semibold mb-2">Alamat <span class="text-red-500">*</span></label>
            ...
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <textarea id="description" name="description" rows="5" class="w-full bg-white rounded-md" placeholder="Deskripsi Kolaborator"></textarea>
            </div>
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <input type="text" name="site" placeholder="Platform Kolaborator"
                    class="w-full py-2.5 px-3 bg-white rounded-md border border-gray-200 text-gray-800 placeholder-gray-500 focus:ring-primary" value="{{ old('site') }}">
                @error('site')
                    <span class="mt-1 text-red-500">Mohon menuliskan website / platform kolaborator terlebih dahulu!</span>
                @enderror
            </div>
            <div class="flex flex-col w-10/12 mb-4">
                <label class="text-gray-600 font-semibold mb-1">Kategori Kolaborator <span class="text-red-500">*</span></label>
                ...
                <div class="w-full flex items-start gap-x-8">
                    ...
                    <div class="flex w-9/12">
                        <div class="relative flex items-center justify-center">
                            <img id="logo" src="{{ asset('images/preview-img.svg') }}" class="w-full object-fill"
                                alt="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col w-10/12 mb-4">
                ...
                <div class="w-full flex items-start gap-x-8">
                    ...
                    <div class="flex w-9/12">
                        <div class="relative flex items-center justify-center">
                            <img id="cover" src="{{ asset('images/preview-img.svg') }}" class="w-full object-fill"
                                alt="" />
                        </div>
                    </div>
                </div>
